...
public class Main {
    ...
    final String digestPassword = "HG58YZ3CR9";
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Encrypted: " + Arrays.toString(codedtext)); // this is a byte array, you'll just see a reference to an array
